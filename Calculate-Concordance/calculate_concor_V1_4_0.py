...
### python [3.8.19]
### matplotlib [3.7.5]
### Copyright: Baiqi Jiang, Or Yaacov & Chakravarti Lab @2024
...
logging.info("Running calculate_concor (V1.4.0)...")
    ...
    for truth_var in truth_vcf:
        ...
        if true_variant_key in call_variants:
            ...
            if truth_simplified == call_simplified:                                 
                ...
                elif sum(truth_simplified) == 1 and sum(call_simplified) == 1:          # Ignore phasing
                    counters[interval_key][variant_type]['tp'] += 1
...
if __name__ == "__main__":
    ...
    logging.info(f"calculate_concor (V1.4.0) finished running successfully. Total runtime: {total_time}")